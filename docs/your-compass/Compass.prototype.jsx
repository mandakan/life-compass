...
(function () {
  ...
  const SEED = [
    {
      id: 'rest',
      name: 'Rest & recovery',
      prompt: 'sleep, movement, slowing down',
      matters: 5,
      weeks: [2, 2, 3],
      details:
        'Move every day, protect my sleep, and make real space to recover instead of pushing through.',
    },
    {
      id: 'close',
      name: 'People close to me',
      prompt: 'being present with them',
      matters: 5,
      weeks: [3, 4, 4],
      details:
        'Be present at dinner, listen without trying to fix, and plan one proper weekend together each month.',
    },
    {
      id: 'friends',
      name: 'Friendships',
      prompt: 'reaching out, staying connected',
      matters: 4,
      weeks: [2, 2, 2],
      details:
        'Reach out first more often. Friendships fade when I wait to be invited.',
    },
    {
      id: 'work',
      name: 'Work',
      prompt: 'meaningful, steady, within limits',
      matters: 3,
      weeks: [4, 3, 4],
      details:
        'Do work that means something, and be the calm, reliable person on the team.',
    },
    {
      id: 'growth',
      name: 'Learning & growth',
      prompt: 'curiosity, at your own pace',
      matters: 4,
      weeks: [3, 3, 3],
      details:
        'Keep learning for its own sake -- finish what I start instead of chasing the next new thing.',
    },
    {
      id: 'self',
      name: 'Time for myself',
      prompt: 'play, rest, nothing in particular',
      matters: 4,
      weeks: [2, 3, 2],
      details:
        'Protect unstructured time. Not everything has to be productive.',
    },
  ];
  ...
  function Spark({ weeks }) {
    ...
    return h(
      'svg',
      { width: W, height: H, style: { flex: 'none' }, 'aria-hidden': true },
      h('path', {
        d,
        fill: 'none',
      ...
      h('circle', {
        cx: (weeks.length - 1) * step,
        cy: y(weeks[weeks.length - 1]),
        r: 3,
        ...
        h(
          ...
          nodes.map(p => {
            ...
            return h(
              ...
              {
                key: p.i,
                onClick: () => onOpen(p.a.id),
                'aria-label': 'Open ' + (p.a.name || 'Untitled'),
                style: {
                  position: 'absolute',
                  left: p.x,
                  top: p.y,
        ...
        h(
          'button',
          {
            ...
            style: {
              ...
              padding: '15px 4px',
              borderBottom:
                i < areas.length - 1 ? '1px solid var(--color-border)' : 'none',
            },
          },
          h(
            'div',
  ...
  function TodayView({ areas, onOpen }) {
    ...
    return h(
      ...
      h(
        ...
        'How close did this past week feel?',
      ),
      h(
        'div',
      ...
      h(
        ...
        Button
          ? h(
              Button,
              { variant: 'primary', onClick: () => onOpen(a.id) },
              'Open & save',
            )
          : null,
        h(
          'button',
          {
            onClick: () => {
              const next =
                areas[(areas.findIndex(x => x.id === pick) + 1) % areas.length];
              setPick(next.id);
              setV(null);
            },
            style: {
  ...
  function WeekView({ areas, onOpen }) {
    ...
    return h(
      ...
      h(
        ...
        'You showed up and noticed how things are. That matters more than any number.',
      ),
      areas.map((a, i) =>
        h(
          'button',
          ...
          h(
            ...
            tender(a)
              ? h(
                  ...
                  'This one matters to you -- somewhere to be kind to yourself.',
                )
              : null,
          ),
        ...
        return h(
          'button',
          {
            ...
            style: {
              ...
              border: '2px solid ' + (on ? c : 'var(--color-border)'),
              background: on
                ? 'color-mix(in srgb, ' + c + ' 14%, var(--color-surface))'
                : 'var(--color-surface)',
              color: 'var(--color-text)',
              fontFamily: 'var(--font-body)',
              fontSize: 'var(--text-sm)',
  ...
  function AreaDetail({ area, onClose, onChange, onRemove }) {
    ...
    const d = drift(area);
    const reflection = (() => {
      if (area.matters >= 4 && livedNow <= 2)
        return 'This matters a lot to you, and lately it has felt far off. Not a failure -- just a gentle signal of where your attention wants to go.';
      if (area.matters >= 4 && livedNow >= 4)
        return 'This matters to you, and you have been living close to it. Worth noticing what is helping.';
      if (d === 0)
        return 'What you value here and how you have lived it are close together right now.';
    ...
    const setLived = n =>
      onChange({
        ...area,
        weeks: area.weeks.slice(0, -1).concat(n),
        isNew: false,
      });
      ...
      h(
        ...
        h('input', {
          ...
          style: {
            ...
            borderBottom:
              '2px solid ' +
              (nameFocus ? 'var(--color-primary)' : 'transparent'),
            outline: 'none',
            padding: '2px 0',
            marginBottom: 8,
          },
        ...
        h('input', {
          ...
          'aria-label': 'A few words for what this means',
          placeholder: 'a few words for what this means to you',
          style: {
            width: '100%',
            boxSizing: 'border-box',
            fontFamily: 'var(--font-body)',
        ...
        h(
          'p',
          { style: help },
          'Your compass needle -- this rarely changes week to week.',
        ),
        h(ScaleChooser, {
          labels: MATTERS,
          value: area.matters,
          onChange: n => set({ matters: n }),
        }),
        ...
        h(
          'p',
          { style: label },
          'How close did you live to it this past week?',
        ),
        h(
          'p',
          { style: help },
          'Just this week. Be honest and kind -- both at once.',
        ),
        h(ScaleChooser, {
          labels: SCALE,
          value: livedNow,
        ...
        h(
          ...
          Button
            ? h(Button, { variant: 'primary', onClick: onClose }, 'Done')
    ...
    return h(
      'div',
      {
        style: {
          maxWidth: 520,
          margin: '0 auto',
          padding: 'clamp(40px, 9vw, 80px) clamp(16px, 5vw, 24px) 80px',
          textAlign: 'center',
        },
      },
      h(
      ...
      h(
        ...
        Button
          ? h(
              Button,
              { size: 'lg', variant: 'primary', onClick: onSuggest },
              'Start from a few common areas',
            )
          : null,
        h(
          'button',
    ...
    return h(
      'div',
      {
        style: {
          maxWidth: 560,
          margin: '0 auto',
          padding: 'clamp(32px, 7vw, 56px) clamp(16px, 5vw, 24px) 80px',
        },
      },
      h(
        'h1',
      ...
      h(
        ...
        'Just starting points -- choose any that fit, skip the rest, and add your own later. Nothing here is fixed.',
      ),
      h(
        'div',
        ...
        Button
          ? h(
              Button,
              {
                ...
                disabled: count === 0,
                onClick: () =>
                  onContinue(SUGGESTIONS.filter((_, i) => picked[i])),
              },
              count === 0
                ? 'Choose a few to continue'
                : 'Continue with ' + count,
            )
          : null,
        h(
  ...
  const VIEWS = [
    {
      id: 'map',
      label: 'Map',
      sub: 'You, and the things that matter around you',
    },
  ...
  function Compass() {
    ...
    const [areas, setAreas] = React.useState(() =>
      SEED.map(a => ({ ...a, weeks: a.weeks.slice() })),
    );
    ...
    const updateArea = next =>
      setAreas(prev => prev.map(a => (a.id === next.id ? next : a)));
    const removeArea = id => {
    ...
    const fromSuggestions = chosen => {
      setAreas(chosen.map(s => newArea(s.name, s.prompt)));
      setPhase('app');
      setView('map');
    };
    const buildOwn = () => {
