...
const Introduction = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto py-4 px-4">
      <h2 className="text-3xl font-bold mb-4">{t('introduction.what_is_title')}</h2>
      <p className="mb-6">{t('introduction.what_is_description')}</p>

      <h3 className="text-2xl font-semibold mb-3">{t('introduction.why_title')}</h3>
      <p className="mb-6">{t('introduction.why_description')}</p>

      <h3 className="text-2xl font-semibold mb-3">{t('introduction.how_title')}</h3>
      ...
      <h3 className="text-2xl font-semibold mb-3">{t('introduction.examples_title')}</h3>
      ...
      <h3 className="text-2xl font-semibold mb-3">{t('introduction.next_steps_title')}</h3>
