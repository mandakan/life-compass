...
const Callout: React.FC<CalloutProps> = ({ children, onDismiss }) => {
  return (
    <div className="bg-[var(--callout-bg)] text-[var(--text)] border border-[var(--callout-border)] border-l-6 rounded-sm p-2 mb-4 flex justify-between items-center font-sans">
      <span>
        {children ||
