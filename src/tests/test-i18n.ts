  ...
  resources: {
    sv: {
      translation: {
        ...
        drag_to_reorder_life_area:
          'Dra och släpp för att ändra ordning på livsområden.',
        reset_life_compass_warning:
          'Är du säker på att du vill återställa livsområden till standard?',
        continue: 'Fortsätt',
        click_to_edit_details: 'Klicka för att redigera detaljer',
        delete: 'Ta bort',
        remove_life_area_warning:
          'Varning: Detta kommer att ta bort livsområdet och alla dess data. Vill du fortsätta?',
